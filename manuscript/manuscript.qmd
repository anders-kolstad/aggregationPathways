...
Given that X~100~ is defined the way it is, it would make more sense for this indicator to follow pathway 3 (@tbl-pathways) by spatially aggregating the variable from plot scale to ecosystem asset to allow spatial compensation between plots.
...
### 5. Don't aggregate indices, unless you know all aggregation operations are commutative {.unnumbered}
...
### 6. Don't present variables and their respective indicators as alternative evidence {.unnumbered}
...
we hope that future ecosystem condition accounts will be more internally consistent, more comparable between each other, have a higher level of reproducibility, and be less susceptible to unintended mathematical artefacts.   
