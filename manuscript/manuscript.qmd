...
Thus, pathway 7 in @tbl-pathways can be written as $project - scale - sample - sp.agg. - trunc$.
...
### 6. Don't present variables and their respective indicators as alternative evidence
...
we hope that future ecosystem condition accounts will be more internally consistent, more comparable between each other, and less susceptible to unintended mathematical artefacts.   
