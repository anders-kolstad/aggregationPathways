...
Given that X~100~ is defined the way it is, this indicator should follow pathway 3 (@tbl-pathways) by spatially aggregating the variable from plot scale to ecosystem asset to allow spatial compensation between plots.
