...
Firstly, it gives a normative interpretation of a variable, defining a good and a bad state (and possibly one or more indermediate states), and simultaneously a directionality to say when something is getting better or worse over time [@czucz_selection_2021].
