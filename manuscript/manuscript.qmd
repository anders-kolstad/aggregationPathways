...
See @nte-billberry for another example.

::: {#nte-billberry .callout-note appearance="minimal" icon="false"}
### Billberry example
...
However, this decision clearly affects the results of the spatial aggregation via a well-described (but often forgotten?) statistical problem referred to at the modifiable area unit problem (MAUP; @nte-rel).
