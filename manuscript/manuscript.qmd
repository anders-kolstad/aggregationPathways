...
The description of indicator pathways can be made even easier by referencing specific aggregation pathways in by number, as we have done in this paper using @fig-pathways in this paper.
...
It will make the interpretation of ECAs less prone to misunderstanding and miss-use, as well as making troubleshooting easier, for example when trying to identify the reason why two ECAs produces dissimilar indicator values from the same underlying data.
